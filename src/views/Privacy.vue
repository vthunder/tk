<template>
    <b-container class="mt-4">
        <b-row align-h="center">
            <b-col md="10">
                <h1>Privacy Policy of Tinker Kitchen Inc.</h1>

                <p>Tinker Kitchen Inc. operates the https://tinkerkitchen.org/
                    website, which provides the SERVICE.</p>
                ...
                <p>The terms used in this Privacy Policy have the same
                    ...
                    accessible at
                    https://tinkerkitchen.org/legal/terms, unless
                    otherwise defined in this Privacy Policy.</p>

                <h2>Information Collection and Use</h2>

                <p>For a better experience while using our Service, we may
                ...
                <p>We want to inform you that whenever you visit our Service,
                ...
                <p>Cookies are files with small amount of data that is
                    commonly used an anonymous unique identifier. These are sent
                    to your browser from the website that you visit and are stored
                    on your computer’s hard drive.</p>

                <p>Our website uses these "cookies" to collection information
                ...
                <p>We want to inform our Service users that these third
                    parties have access to your Personal Information. The reason
                    is to perform the tasks assigned to them on our
                ...
                <p>Our Service may contain links to other sites. If you click
                ...
                <p>Our Services do not address anyone under the age of 13. We
                ...
                <p>If you have any questions or suggestions about our Privacy
                    ...
                    <a href="mailto:hello@tinkerkitchen.org">contact us</a>.</p>
            </b-col>
        </b-row>
    </b-container>
</template>
