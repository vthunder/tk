<template>
    <b-container>
        ...
        <p>There are several ways to have a group activity at Tinker
                ...
                <b-tab title="Team Building" active>
                    ...
                    <b-row class="mt-4">
                        ...
                        <b-col sm="7">
                            ...
                            <p>Learn about chocolate and make a
                                variety of shapes of solid bonbons
                                with dark Belgian chocolate. Some will
                                have fancy decorations on the top just
                                like at a chocolatier shop. Decorate
                                boxes and take some home with you to
                                give to a special someone.</p>
                        </b-col>
                    </b-row>
                    <b-row class="mt-4">
                        <b-col sm="5" order-sm="2">
                            <img class="feature-img"
                              src="/images/Pasta.jpg"/>
                        </b-col>
                        <b-col sm="7">
                            <h3>Pasta Extrusion</h3>
                            <p>Learn to make pasta from scratch using
                                a commercial extruder! We’ll make
                                different shapes colors, and an
                                oven-roasted tomato sauce to go with
                                it.</p>
                        </b-col>
                    </b-row>
                    <b-row class="mt-4">
                        ...
                        <b-col sm="7">
                            ...
                            <p>Learn how to make various flavors of
                                rich custard ice cream using modern
                                techniques: sous vide cooking, batch
                                freezing, and a “paco
                                jet”. Optionally, we can also get
                                liquid nitrogen!</p>
                        </b-col>
                    </b-row>
                    ...
                    <ul class="mt-4">
                        ...
                        <li>Need to include lunch, but you're only
                            interested in a dessert-focused activity? No
                    ...
                    <p>Awesome! Shoot us an email at
                        hello@tinkerkitchen.org so we can
                        schedule. Can't wait to cook with you!</p>
                </b-tab>
                <b-tab title="Dinner Party">
                    <p>Tinker Kitchen is the perfect space for your
                        dinner party!</p>
                    <p>As a member, you can always bring a +1 with you
                        ...
                        passes!</p>
                    <p>You can invite additional guests to have dinner
                        for <strong>just $10 each</strong>. Available
                        for members only. Guests limited to dining
