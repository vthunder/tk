  ...
  <b-container class="mt-4">
    <b-row align-h="center">
      <b-col md="10">
        ...
        <p>
          You are granted limited license only for purposes
        ...
        <p>
          Please read <b-link :to="{ name: 'legal-privacy' }">our
        ...
        <p>
          In no event shall Tinker Kitchen Inc., nor any of
        ...
        <p>
          You hereby indemnify to the fullest extent Tinker
        ...
        <p>
          Tinker Kitchen Inc. is permitted to revise these
        ...
        <p>
          The Tinker Kitchen Inc. is allowed to assign,
