<template>
  <b-container>
    <h1 class="mt-4">Commercial Use</h1>

    <b-row class="justify-content-center">
      <b-col md="10">
        <p>
          Although we don't allow food production at this time, we
        ...
        <p>
          We have a network of mentors and experts that can
        ...
        <p>
          Because we're a great events space, we can also
          host micro-popup events and classes/demos designed
          to get customer feedback and refine your products.</p>
      </b-col>
    </b-row>
