<template>
  <b-container>
    ...
    <b-card-group v-for="i in Math.ceil(press.length / 2)" :key="i">
      <b-card
        v-for="item in press.slice((i - 1) * 2, i * 2)" :key="item"
        bg-variant="white">
    ...
    <b-row>
      <b-col md="6" class="boilerplate">
        ...
        <p class="info-fact mb-3">
          Tinker Kitchen is a new maker space
        ...
        <h4>Founder Bio</h4>
        <p class="info-fact mb-3">
          Dan is the founder of Tinker Kitchen,
      ...
      <b-row>
        <b-col sm="4" offset-sm="4">
          ...
          <b-row>
            ...
            <b-col sm="4">
              <b-button
                href="mailto:press@tinkerkitchen.org"
                variant="primary">Contact</b-button>
            </b-col>
          </b-row>
        </b-col>
      </b-row>
