<template>
  ...
  <div v-else class="container section">
    <AdminPage>
      <div id="admin-events" class="tab-pane fade show active" role="tabpanel">
        <h3>New Event:</h3>
        <b-form id="new_event_form" @submit.prevent="doNewEvent">
          <b-container fluid>
            <b-row>
              ...
              <b-col sm="9">
                <b-form-input id="input_title" v-model="event.title" type="text"/>
              </b-col>
            </b-row>
            <b-row>
              ...
              <b-col sm="9">
                <b-form-select
                  id="input_category" v-model="event.category"
            ...
            <b-row>
              ...
              <b-col sm="9">
                <b-form-input id="input_date" v-model="event.date" type="date"/>
              </b-col>
            </b-row>
            <b-row>
              <b-col sm="3"><label for="input_time">Time:</label></b-col>
              <b-col sm="9">
                <b-form-input id="input_time" v-model="event.time" type="time"/>
              </b-col>
            </b-row>
            <b-row>
              <b-col sm="3">
              ...
              <b-col sm="9">
                <b-form-input id="input_duration" v-model="event.duration" type="number"/>
              </b-col>
            </b-row>
            <b-row>
            ...
            <b-row>
              ...
              <b-col sm="9">
                <b-form-select
                  id="input_price_member"
                  v-model="event.member_sku_id"
                  :options="price_member_options"/>
              </b-col>
            </b-row>
            <b-row>
              <b-col sm="3">
              ...
              <b-col sm="9">
                <b-form-file
                  v-model="event.image_header_file"
            ...
            <b-row>
              ...
              <b-col sm="9">
                <b-form-textarea id="input_description" v-model="event.description" rows="6"/>
              </b-col>
            </b-row>
          </b-container>
        </b-form>
        <div class="text-right mr-3">
          <b-button class="mt-2" @click="doNewEvent">Make New Event</b-button>
        </div>
      </div>
    </AdminPage>
    <b-modal
      id="new-event-modal" ref="newEventModalRef"
